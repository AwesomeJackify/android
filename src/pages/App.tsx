      ...
      <div className="bg-black overflow-hidden">
        <div className="flex min-h-screen flex-col max-w-lg mx-auto relative">
          ...
          <div className="flex z-10 px-2 max-w-screen-xl pt-4 mx-auto w-full flex-col gap-2 max-md:gap-8  max-md:pt-8 relative grow">
            <div className="bg-gradient-to-b from-gray-500 to-black border border-white mt-4    grow max-h-40 w-full -z-10 rounded-2xl  ">
              <div className="flex w-full gap-16 items-center justify-stretch ">
                <div className="bg-gradient-to-b ml-4 relative  from-slate-100 to-slate-200 border border-white    bottom-4 shadow-large    rounded-md h-36 w-48 ">
                  ...
                  <h1 className="text-2xl opacity-80 left-2 shadow-md bg-gradient-to-r from-gray-500 via-black to-slate-600 inline-block bg-clip-text text-transparent  absolute bottom-3   ">
                    PM
                  </h1>
